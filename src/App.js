        ...
        <div id="home-page">
          ...
          <div className="game">
            <div className="image-wrap">
              <img src="./images/CoverFire.png" alt="something" />
            </div>
            <h3>Cover Fire</h3>
          ...
          <div className="game">
            <div className="image-wrap">
              <img src="./images/ZombieLang.png" alt="something" />
            </div>
            <h3>Zombie Lang</h3>
            <div className="rating">
              <span>☆</span>
          ...
          <div className="game">
            <div className="image-wrap">
              <img src="./images/MineCraft.png" alt="something" />
            </div>
            <h3>MineCraft</h3>
            <div className="rating">
              <span>☆</span>
      ...
      <section id="catalog-page">
        ...
        <div className="allGames">
          <div className="allGames-info">
            <img src="./images/avatar-1.jpg" alt="something" />
            <h6>Action</h6>
            <h2>Cover Fire</h2>
